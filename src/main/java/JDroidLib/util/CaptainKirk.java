...
import JDroidLib.interfaces.Disposeable;
...
public class CaptainKirk implements Disposeable {
    ...
    private File workingDir = new File(System.getProperty("user.home"), "ADB-Fastboot-Work");
     ...
     */
    public String executeCommand(Command command, boolean killServerAfter) throws IOException {
        ...
        if(killServerAfter)executeCommand(Command.getAnonymousCommand(Command.CommandType.ANONYMOUS_COMMAND, Command.convertArrayToList("kill-server"), false, true), false);
