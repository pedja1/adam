...
public class ResourceManager {
    ...
    private class Installer {
        ...
        private void installOnLinux(File location) throws IOException, InterruptedException {
            ...
            if (!installDir.exists())
                try {
                    ...
                    InputStream input = this.getClass().getResourceAsStream("/adb_tools/adb/adb");
                    ...
                    output.close();
                    /*# ========== #*/
                    input = this.getClass().getResourceAsStream("/adb_tools/adb/fastboot");
                    ...
                    output.close();
                    /*# ========== #*/
                    input = this.getClass().getResourceAsStream("/adb_tools/adb/ddms.jar");
        ...
        private void installOnMac(File location) throws IOException, InterruptedException {
            ...
            if (!installDir.exists()) {
                installDir.getParentFile().mkdirs();
                InputStream input = this.getClass().getResourceAsStream("/adb_tools/adb-mac/adb");
                File adb_tools = new File(location + "/adb");
                OutputStream output = new FileOutputStream(adb_tools);
                int readBytes = 0;
                byte[] buffer = new byte[4096];
                ...
                output.close();
                /*# ========== #*/
                input = this.getClass().getResourceAsStream("/adb_tools/adb-mac/fastboot");
                adb_tools = new File(location + "/fastboot");
                output = new FileOutputStream(adb_tools);
                readBytes = 0;
                buffer = new byte[4096];
                ...
                output.close();
                /*# ========== #*/
                input = this.getClass().getResourceAsStream("/adb_tools/adb-mac/ddms.jar");
                adb_tools = new File(location + "/ddms.jar");
                output = new FileOutputStream(adb_tools);
                readBytes = 0;
                buffer = new byte[4096];
        ...
        private void installOnWin(File location) throws IOException, InterruptedException {
            ...
            if (!installDir.exists()) {
                installDir.getParentFile().mkdirs();
                InputStream input = this.getClass().getResourceAsStream("/adb_tools/adb-win/adb.exe");
                ...
                output.close();
                /*# ========== #*/
                input = this.getClass().getResourceAsStream("/adb_tools/adb-win/AdbWinApi.dll");
                ...
                output.close();
                /*# ========== #*/
                input = this.getClass().getResourceAsStream("/adb_tools/adb-win/AdbWinUsbApi.dll");
                ...
                output.close();
                /*# ========== #*/
                input = this.getClass().getResourceAsStream("/adb_tools/adb-win/fastboot.exe");
                ...
                output.close();
                /*# ========== #*/
                input = this.getClass().getResourceAsStream("/adb_tools/adb-win/ddms.jar");
                adb_tools = new File(location + "/ddms.jar");
                output = new FileOutputStream(adb_tools);
                readBytes = 0;
                buffer = new byte[4096];
