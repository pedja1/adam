    ...
    public String toString() {
        if (commandType == CommandType.ADB_COMMAND) 
            return String.format(
                      "Command object. Command type: %s\n"
                    + "Device info: %s\n"
                    + "Command args: %s\n"
                    + "Will printOutput: %s", commandType.toString(), device.toString(), parameters.toArray().toString(), String.valueOf(returnOutput));
        else if (commandType == CommandType.FASTBOOT_COMMAND) 
            return String.format(
                      "Command object. Command type: %s\n"
                    + "Device info: %s\n"
                    + "Command args: %s\n"
                    + "Will printOutput: %S", commandType.toString(), serial, parameters.toArray().toString(), String.valueOf(returnOutput));
        else 
            return String.format(
                      "Command object. Command type: %s\n"
                    + "Device info: %s\n"
                    + "Command args: %s\n"
                    + "Will printOutput: %s", commandType.toString(), "n/a", parameters.toArray().toString(), String.valueOf(returnOutput));
    }*/
